...
/**
 * Sample activity showing how to properly enable custom fullscreen_demo behavior.
 * <p/>
 * This is the preferred way of handling fullscreen_demo because the default fullscreen_demo implementation
...
public class FullscreenDemoActivity extends YouTubeFailureRecoveryActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // You can use your own button to switch to fullscreen_demo too
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player,
        ...
        this.player = player;
        setControlsEnabled();
        // Specify that we want to handle fullscreen_demo behavior ourselves.
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            ...
            // should never be laid out in landscape mode (since the video will be fullscreen_demo whenever the
            ...
            // programmatically here since this activity demos fullscreen_demo behavior both with and without
            // this flag).
    ...
    private void doLayout() {
        ...
        if (fullscreen) {
            // When in fullscreen_demo, the visibility of all other views than the player should be set to
